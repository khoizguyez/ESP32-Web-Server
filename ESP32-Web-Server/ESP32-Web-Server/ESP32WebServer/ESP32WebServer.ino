...
const char* ssid     = "ESP8266-Network";
const char* password = "Esp8266-Password";
...
const int ledPin16 = D0; // Change pin numbers according to your ESP8266 board
const int ledPin17 = D1;
...
void setup() {
  ...
  digitalWrite(ledPin16, LOW);    // turn LED off by default
  pinMode(ledPin17, OUTPUT);      // set the LED pin mode
  digitalWrite(ledPin17, LOW);    // turn LED off by default
